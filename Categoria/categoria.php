...
<head>
    ...
    <link rel="stylesheet" href="../include/categoria.css">
</head>

<body>
    <div class="container mt-5 pt-5">
        <h1 class="display-4 py-3">Lista de Categorias</h1>
        <p class="lead"></p>
    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-secondary"
                                        href="editar_categoria.php?id=<?php echo $categoria['CATEGORIA_ID']; ?>">Editar</a>
                                    |
