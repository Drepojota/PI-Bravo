...
<head>
    ...
    <link rel="stylesheet" href="../include/editar_produto.css">
</head>

<body>
    <div class="mt-3">
        <h1 class="display-4 py-2">Editar Produtos</h1>
    </div>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <p>
                        <tr>
                            ...
                            <input type="number" name="preco" id="preco" step="0.01"
                                value="<?= $produto['PRODUTO_PRECO'] ?>" required>
                        </tr>
                    <p>
                        <tr>
                            <label for="desconto">Desconto:</label>
                            <input type="number" name="desconto" id="desconto" step="0.01"
                                value="<?= $produto['PRODUTO_DESCONTO'] ?>" required>
                        </tr>
                    <p>
                        <tr>
                            <label for="categoria_id">Categoria:</label>
                            <select name="categoria_id" class="btn btn-light" id="categoria_id" required>
                        </tr>
                        <?php
                    ...
                    <p>
                        <tr>
                            ...
                            <input type="number" name="produto_qtd" id="produto_qtd"
                                value="<?= isset($produto_estoque['PRODUTO_QTD']) ? $produto_estoque['PRODUTO_QTD'] : 0 ?>"
                                required>
                        </tr>
                    <P>
                        <tr>
                    ...
                    <p>
                        <button type="submit" class="btn btn-secondary" data-bs-toggle="modal"
                            data-bs-target="#exampleModal">Atualizar Produto</button>
