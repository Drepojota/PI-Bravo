...
<head>
    ...
    <script>
        ...
        // Chama a função para carregar as categorias no início
        atualizarCategorias();

        // Define a função para ser chamada a cada 15 segundos
        setInterval(atualizarCategorias, 15000);
    </script>
</head>
    ...
    <div class="container bg-dark">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <p>
                ...
                <button type="button" class="btn btn-small btn-outline-light" data-bs-toggle="modal"
                    data-bs-target="#exampleModal" id="btnSubmitForm">
                    +
                </button>
                <!-- Modal -->
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <iframe src="../Categoria/criar_categoria2.php" width="100%" height="400px"
